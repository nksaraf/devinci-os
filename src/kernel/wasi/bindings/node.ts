...
import type { WASIBindings } from '../index';
import type { BigIntPolyfillType } from '../polyfills/bigint';
import getBigIntHrtime from '../polyfills/hrtime.bigint';

let bigIntHrtime: (time?: [number, number]) => BigIntPolyfillType = getBigIntHrtime(process.hrtime);
