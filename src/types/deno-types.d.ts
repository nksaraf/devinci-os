...
declare namespace Deno {
   ...
   * ```
   */
  export function setRaw(rid: number, mode: boolean, options?: SetRawOptions): void;
   ...
   *
   * Requires `allow-net` permission. */
  export function listenDatagram(options: ListenOptions & { transport: 'udp' }): DatagramConn;
