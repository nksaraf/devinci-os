<script lang="ts">
  ...
  function handleContextMenu(e: MouseEvent) {
    ...
    if (!(targetElement?.contains(e.target as HTMLElement) || targetElement === e.target))
    ...
    // console.log(e, targetElement, x, y, xPos, yPos);
...
<div
  ...
  class="flex w-full grid-container relative"
>
  <div ml-auto>
    <FinderGrid
      path="/home"
