import type { FileSystemOptions } from './core/file_system.ts';
import {
  AsyncKeyValueROTransaction,
  AsyncKeyValueRWTransaction,
  AsyncKeyValueStore,
  AsyncKeyValueFileSystem,
} from './core/key_value_filesystem.ts';
import { ApiError, ErrorCode } from '../lib/error.ts';
import global from '$lib/global.ts';
import { arrayBuffer2Buffer, buffer2ArrayBuffer } from './utils/util.ts';
/**
