...
import type { Remote } from '../comlink/mod.ts';
import { fromWireValue, toWireValue } from '../comlink/http.handlers.ts';
import type { VirtualFileSystem } from './virtual.ts';
import type { SharedFileSystem } from './shared.ts';
import VirtualFile from './core/virtual_file.ts';
import Stats, { FileType } from './core/stats.ts';
