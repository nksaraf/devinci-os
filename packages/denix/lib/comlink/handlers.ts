...
import Stats from '../fs/core/stats.ts';
import { RemoteFile } from '../fs/remote.ts';
import { SharedFile } from '../fs/shared.ts';
import { fromWireValue, toWireValue, transferHandlers } from './comlink.ts';

import type { TransferHandler } from './comlink.ts';
import { createResourceTable, resourceTableSymbol } from '../../types.ts';
import type { ResourceTable } from '../../types.ts';
import { FileResource } from '../../ops/fs.ops.ts';
import type VirtualFile from '../fs/core/virtual_file.ts';
