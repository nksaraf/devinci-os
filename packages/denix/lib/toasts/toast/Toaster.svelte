<script lang="ts">
  ...
  import { setContext } from 'svelte.ts';
  import { flip } from 'svelte/animate.ts';
  import { quintOut } from 'svelte/easing.ts';
  import BaseToast from './BaseToast.svelte.ts';
  import type { Position } from './position.ts';
  import { freezeToasts, thawToasts } from './toast.ts';
