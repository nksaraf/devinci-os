...
import VirtualFile from '../fs/core/virtual_file.ts';
import type { ActiveCharPrompt, ActivePrompt } from './utils.ts';
import { InMemoryPipe } from '../pipe.ts';
import { constants } from '../constants.ts';
import { Buffer } from 'buffer';
import { LineDiscipline } from './line_discipline.ts';
