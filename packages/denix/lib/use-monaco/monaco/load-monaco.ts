...
import { endingSlash, noEndingSlash } from './utils.ts';
import withPlugins from './plugin-api.ts';
import languagesPlugin from './languages/register.ts';
import themes from './themes.ts';
import editors from './editors.ts';
import shortcuts from './shortcuts.ts';
import workers, { createBlobURL } from './workers.ts';
import { createPlugin } from './plugin-api.ts';

import editorWorker from 'monaco-editor/esm/vs/editor/editor.worker?worker.ts';
import jsonWorker from 'monaco-editor/esm/vs/language/json/json.worker?worker.ts';
import cssWorker from 'monaco-editor/esm/vs/language/css/css.worker?worker.ts';
import htmlWorker from 'monaco-editor/esm/vs/language/html/html.worker?worker.ts';
import tsWorker from 'monaco-editor/esm/vs/language/typescript/ts.worker?worker.ts';
