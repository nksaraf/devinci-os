...
declare module 'monaco-editor' {
  namespace editor {
    ...
    export function setTheme(themeName: string | monacoApi.editor.IStandaloneThemeData): void;

    export function getTheme(themeName: string): monacoApi.editor.IStandaloneThemeData | null;
    ...
    export function onDidChangeTheme(
      listener: (theme: { name: string; theme: monacoApi.editor.IStandaloneThemeData }) => void,
    ): monacoApi.IDisposable;
  }
}

export default createPlugin({ name: 'core.themes', dependencies: ['core.editors'] }, (monaco) => {
  ...
  monaco.editor.setTheme = (theme: string | monacoApi.editor.IStandaloneThemeData) => {
