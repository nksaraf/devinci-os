...
import { createPlugin } from './plugin-api.ts';
...
declare module 'monaco-editor' {
  namespace editor {
    ...
    // export function getDefaultEditorOptions(): monacoApi.editor.IEditorOptions;
    // export function setDefaultEditorOptions(
    ...
    export function getEditors(): monacoApi.editor.IStandaloneCodeEditor[];
...
export default createPlugin(
  ...
  (monaco) => {
    ...
    let editors: monacoApi.editor.IStandaloneCodeEditor[] = [];
    let focusedEditor: monacoApi.editor.IStandaloneCodeEditor | null = null;
...
// @ts-ignore
// import { BaseEditorQuickOpenAction } from '../../node_modules/monaco-editor/esm/vs/editor/standalone/browser/quickOpen/editorQuickOpen.ts';
// @ts-ignore
// import {
//   QuickOpenModel,
//   QuickOpenEntry,
//   // @ts-ignore
// } from '../../node_modules/monaco-editor/esm/vs/base/parts/quickopen/browser/quickOpenModel.ts';
// @ts-ignore
// import { matchesFuzzy } from '../../node_modules/monaco-editor/esm/vs/base/common/filters.ts';
