import { loadWASM } from 'onigasm.ts';
import { Registry } from 'monaco-textmate.ts';
import { StackElement, INITIAL } from 'monaco-textmate.ts';
import type * as monacoApi from 'monaco-editor.ts';
import { textMateToMonacoToken } from './tm-to-monaco-token.ts';
